 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getParameter_type_list <em>Parameter type list</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_abstract_declarator_complement()
 * @model
 * @generated
 */
public interface direct_abstract_declarator_complement extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_abstract_declarator_complement_Assignment_expression()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getAssignment_expression <em>Assignment expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_abstract_declarator_complement_Type_qualifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getType_qualifier_list <em>Type qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_abstract_declarator_complement_Parameter_type_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_abstract_declarator_complement#getParameter_type_list <em>Parameter type list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
