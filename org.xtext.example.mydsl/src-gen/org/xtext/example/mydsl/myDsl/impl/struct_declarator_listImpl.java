 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.struct_declarator_listImpl#getStruct_declarator_list_linha <em>Struct declarator list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class struct_declarator_listImpl extends MinimalEObjectImpl.Container implements struct_declarator_list
{
  ...
  public NotificationChain basicSetStruct_declarator_list_linha(struct_declarator_list_linha newStruct_declarator_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST_LINHA, oldStruct_declarator_list_linha, newStruct_declarator_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStruct_declarator_list_linha(struct_declarator_list_linha newStruct_declarator_list_linha)
  {
    if (newStruct_declarator_list_linha != struct_declarator_list_linha)
    {
      ...
      if (struct_declarator_list_linha != null)
        msgs = ((InternalEObject)struct_declarator_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST_LINHA, null, msgs);
      if (newStruct_declarator_list_linha != null)
        msgs = ((InternalEObject)newStruct_declarator_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST_LINHA, null, msgs);
      msgs = basicSetStruct_declarator_list_linha(newStruct_declarator_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST_LINHA, newStruct_declarator_list_linha, newStruct_declarator_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST_LINHA:
