 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.logical_and_expressionImpl#getLogical_and_expression_linha <em>Logical and expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class logical_and_expressionImpl extends MinimalEObjectImpl.Container implements logical_and_expression
{
  ...
  public NotificationChain basicSetLogical_and_expression_linha(logical_and_expression_linha newLogical_and_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOGICAL_AND_EXPRESSION__LOGICAL_AND_EXPRESSION_LINHA, oldLogical_and_expression_linha, newLogical_and_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLogical_and_expression_linha(logical_and_expression_linha newLogical_and_expression_linha)
  {
    if (newLogical_and_expression_linha != logical_and_expression_linha)
    {
      ...
      if (logical_and_expression_linha != null)
        msgs = ((InternalEObject)logical_and_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOGICAL_AND_EXPRESSION__LOGICAL_AND_EXPRESSION_LINHA, null, msgs);
      if (newLogical_and_expression_linha != null)
        msgs = ((InternalEObject)newLogical_and_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOGICAL_AND_EXPRESSION__LOGICAL_AND_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetLogical_and_expression_linha(newLogical_and_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOGICAL_AND_EXPRESSION__LOGICAL_AND_EXPRESSION_LINHA, newLogical_and_expression_linha, newLogical_and_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.LOGICAL_AND_EXPRESSION__LOGICAL_AND_EXPRESSION_LINHA:
