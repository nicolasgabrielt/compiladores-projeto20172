 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.inclusive_or_expressionImpl#getInclusive_or_expression_linha <em>Inclusive or expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class inclusive_or_expressionImpl extends MinimalEObjectImpl.Container implements inclusive_or_expression
{
  ...
  public NotificationChain basicSetInclusive_or_expression_linha(inclusive_or_expression_linha newInclusive_or_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION_LINHA, oldInclusive_or_expression_linha, newInclusive_or_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInclusive_or_expression_linha(inclusive_or_expression_linha newInclusive_or_expression_linha)
  {
    if (newInclusive_or_expression_linha != inclusive_or_expression_linha)
    {
      ...
      if (inclusive_or_expression_linha != null)
        msgs = ((InternalEObject)inclusive_or_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      if (newInclusive_or_expression_linha != null)
        msgs = ((InternalEObject)newInclusive_or_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetInclusive_or_expression_linha(newInclusive_or_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION_LINHA, newInclusive_or_expression_linha, newInclusive_or_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION_LINHA:
