 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.exclusive_or_expressionImpl#getExclusive_or_expression_linha <em>Exclusive or expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class exclusive_or_expressionImpl extends MinimalEObjectImpl.Container implements exclusive_or_expression
{
  ...
  public NotificationChain basicSetExclusive_or_expression_linha(exclusive_or_expression_linha newExclusive_or_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, oldExclusive_or_expression_linha, newExclusive_or_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExclusive_or_expression_linha(exclusive_or_expression_linha newExclusive_or_expression_linha)
  {
    if (newExclusive_or_expression_linha != exclusive_or_expression_linha)
    {
      ...
      if (exclusive_or_expression_linha != null)
        msgs = ((InternalEObject)exclusive_or_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      if (newExclusive_or_expression_linha != null)
        msgs = ((InternalEObject)newExclusive_or_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetExclusive_or_expression_linha(newExclusive_or_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, newExclusive_or_expression_linha, newExclusive_or_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA:
