 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.translation_unitImpl#getTranslation_unit_linha <em>Translation unit linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class translation_unitImpl extends MinimalEObjectImpl.Container implements translation_unit
{
  ...
  public NotificationChain basicSetTranslation_unit_linha(translation_unit_linha newTranslation_unit_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.TRANSLATION_UNIT__TRANSLATION_UNIT_LINHA, oldTranslation_unit_linha, newTranslation_unit_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTranslation_unit_linha(translation_unit_linha newTranslation_unit_linha)
  {
    if (newTranslation_unit_linha != translation_unit_linha)
    {
      ...
      if (translation_unit_linha != null)
        msgs = ((InternalEObject)translation_unit_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TRANSLATION_UNIT__TRANSLATION_UNIT_LINHA, null, msgs);
      if (newTranslation_unit_linha != null)
        msgs = ((InternalEObject)newTranslation_unit_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TRANSLATION_UNIT__TRANSLATION_UNIT_LINHA, null, msgs);
      msgs = basicSetTranslation_unit_linha(newTranslation_unit_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TRANSLATION_UNIT__TRANSLATION_UNIT_LINHA, newTranslation_unit_linha, newTranslation_unit_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.TRANSLATION_UNIT__TRANSLATION_UNIT_LINHA:
